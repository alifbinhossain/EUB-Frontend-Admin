...
const VideoPreview: React.FC<{ preview: string | ArrayBuffer | null; small?: boolean }> = ({ preview, small }) => {
	if (small) {
		return (
			<div className='flex flex-col items-center justify-center pb-6 pt-5'>
				{preview ? (
					<img className='max-h-[50px] rounded-lg' src={preview as string} alt='User image' />
				) : (
					<>
