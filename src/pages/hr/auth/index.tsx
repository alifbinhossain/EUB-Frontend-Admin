...
const User = () => {
	...
	const { data, isLoading, url, deleteData, postData, updateData, refetch } = useHrAuth<IUserTableData[]>({
		status,
	});

	const pageInfo = useMemo(() => new PageInfo('Admin/Authentication', url, 'admin__auth'), [url]);
