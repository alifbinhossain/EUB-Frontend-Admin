...
import { visitorColumns } from './config/columns';
import { ICategoryTableData } from './config/columns/columns.type';
import { useVisitor } from './config/query';

const AddOrUpdate = lazy(() => import('./add-or-update'));
const DeleteModal = lazy(() => import('@core/modal/delete'));

const Designation = () => {
	const { data, isLoading, url, deleteData, postData, updateData, refetch } = useVisitor<ICategoryTableData[]>();
